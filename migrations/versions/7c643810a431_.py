...
def downgrade():
    ...
    sa.Column('description', sa.VARCHAR(length=32), autoincrement=False, nullable=True),
    ...
    sa.Column('name', sa.VARCHAR(length=32), autoincrement=False, nullable=True),
    sa.Column('ingredients', sa.VARCHAR(length=400), autoincrement=False, nullable=True),
    sa.Column('directions', sa.VARCHAR(length=400), autoincrement=False, nullable=True),
    sa.Column('category_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('date_created', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('date_modified', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['category_id'], ['categories.id'], name='recipes_category_id_fkey'),
